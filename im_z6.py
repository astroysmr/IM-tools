...
PCII_mean = np.loadtxt('PCII.z6.gong.csv',delimiter=',')
...
sigma_pix = bb*0.58*u.mJy * (Totalobstime/(1000.*u.hour))**-0.5 * (Wscan**2/(1.*u.deg**2))**0.5 / beam**2
#sigma_pix = (1./1.37)**0.5 * u.mJy * u.h**0.5 / beam
...
plt.savefig('figs/fig.'+str(int(Totalobstime.value))+'h.'+str(Wscan.value)+'degscan.'+casename+'.gong_z6.png')
plt.show()
